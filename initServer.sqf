...
_respawnmsg = "New fighters have joined the cause!"; // Message sent to everyone in chat about reinforcement wave happening, set to "" to have no message
...
missionNamespace setVariable ['f_var_mission_timer',2, true]; // Safestart duration. Value in minutes
