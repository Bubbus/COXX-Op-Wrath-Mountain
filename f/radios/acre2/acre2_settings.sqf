...
f_radios_settings_acre2_longRange = ["co", "dc", "vc", "ftl", "veh-drv"];
...
f_radios_settings_acre2_lr_groups_blufor = [
    ["GRND COMMAND 1",    ["LIBERTY","FREEDOM","INDEPENDENCE","JUSTICE","ENG1","MMG1","HMG1","MAT1","HAT1","MTR1","MSAM1","HSAM1","ST1","DT1"]],
